...
describe('normalizeGitHubRepoName', () => {
  it('should keep owner and repo input unchanged', () => {
    expect(normalizeGitHubRepoName('Aditya-0709/LeetCode-Problems')).toBe(
      'Aditya-0709/LeetCode-Problems'
    );
  });

  it('should convert GitHub URLs to owner and repo', () => {
    expect(normalizeGitHubRepoName('https://github.com/Aditya-0709/LeetCode-Problems')).toBe(
      'Aditya-0709/LeetCode-Problems'
    );
  });

  it('should ignore extra URL path parts', () => {
    expect(
      normalizeGitHubRepoName('https://github.com/Aditya-0709/LeetCode-Problems/tree/main')
    ).toBe('Aditya-0709/LeetCode-Problems');
  });

  it('should convert SSH GitHub remotes to owner and repo', () => {
    expect(normalizeGitHubRepoName('git@github.com:Aditya-0709/LeetCode-Problems.git')).toBe(
      'Aditya-0709/LeetCode-Problems'
    );
  });

  it('should recover from a username-prefixed GitHub URL', () => {
    expect(
      normalizeGitHubRepoName(
        'Aditya-0709/https://github.com/Aditya-0709/LeetCode-Problems'
      )
    ).toBe('Aditya-0709/LeetCode-Problems');
  });
});
