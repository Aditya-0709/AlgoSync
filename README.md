<h1 align="center">
  <a href="https://standardjs.com"><img src="assets/octocode.png" alt="AlgoSync - Automatically sync your code to GitHub." width="400"></a>
  <br>
  <a href="https://chrome.google.com/webstore/detail/leethub-v2/mhanfgfagplhgemhjfeolkkdidbakocm">AlgoSync</a> - Automatically sync your code to GitHub.
  <br>
  <br>
</h1>
...
<!-- <div align="center">
  <a href="https://www.producthunt.com/posts/leethub?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-leethub" target="_blank">
    <img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=275757&theme=light" alt="AlgoSync - Automatically sync your code b/w Leetcode & GitHub. | Product Hunt" />
  </a>
...
<!-- ## AlgoSync progress and numbers (YouTube Video):
[![AlgoSync](https://user-images.githubusercontent.com/43754306/165053510-a757c95e-c3bc-49d5-995c-7a52368abd37.png)](https://www.youtube.com/watch?v=o33PIjqlOgw "AlgoSync saves lives!") -->
...
As of now, GitHub is developers' #1 portfolio. AlgoSync just makes it much easier (autonomous) to keep track of progress and contributions on the largest network of engineering community, GitHub.</p>
...
## How does AlgoSync work?     

<p>It's as simple as:</p>
<ol>
  <li>After installation, launch AlgoSync.</li>
  <li>Click on "authorize with GitHub" button to automatically set up your account with AlgoSync.</li>
  <li>Setup an existing/new repository with AlgoSync (private by default) by clicking "Get Started" button.</li>
...
## Why did I decide to work on AlgoSync?
<p>
...
# How to set up AlgoSync for local development?
  ...
  7. Select the `./dist/chrome` or `./dist/firefox` AlgoSync folder
